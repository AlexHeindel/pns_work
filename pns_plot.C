...
void pns_plot()
{
	...
	*/
	...
	TCanvas *c7 = new TCanvas();
        posiney->Draw();
        c7->SaveAs("images/posiney_test.png");
	TCanvas *c8 = new TCanvas();
        posinez->Draw();
        c8->SaveAs("images/posinez_test.png");
	
	TCanvas *c9 = new TCanvas();
        posinex303->Draw();
        c9->SaveAs("images/posinex303_test.png");
	TCanvas *c10 = new TCanvas();
        posiney303->Draw();
        c10->SaveAs("images/posiney303_test.png");
	TCanvas *c11 = new TCanvas();
        posinez303->Draw();
        c11->SaveAs("images/posinez303_test.png");

	TCanvas *c12 = new TCanvas();
        posinex306->Draw();
        c12->SaveAs("images/posinex306_test.png");
	TCanvas *c13 = new TCanvas();
        posiney306->Draw();
        c13->SaveAs("images/posiney306_test.png");
	TCanvas *c14 = new TCanvas();
        posinez306->Draw();
        c14->SaveAs("images/posinez306_test.png");
	
	TCanvas *c15 = new TCanvas();
        mominex->Draw();
        c15->SaveAs("images/mominex_test.png");
	TCanvas *c16 = new TCanvas();
        mominey->Draw();
        c16->SaveAs("images/mominey_test.png");
	TCanvas *c17 = new TCanvas();
        mominez->Draw();
        c17->SaveAs("images/mominez_test.png");
	TCanvas *c18 = new TCanvas();
        toteine->Draw();
        c18->SaveAs("images/toteine_test.png");
	TCanvas *c19 = new TCanvas();
        kineine->Draw();
        c19->SaveAs("images/kineine_test.png");
	
	TCanvas *c20 = new TCanvas();
        mominex303->Draw();
        c20->SaveAs("images/mominex303_test.png");
	TCanvas *c21 = new TCanvas();
        mominey303->Draw();
        c21->SaveAs("images/mominey303_test.png");
	TCanvas *c22 = new TCanvas();
        mominez303->Draw();
        c22->SaveAs("images/mominez303_test.png");
	TCanvas *c23 = new TCanvas();
        toteine303->Draw();
        c23->SaveAs("images/toteine303_test.png");
	TCanvas *c24 = new TCanvas();
        kineine303->Draw();
        c24->SaveAs("images/kineine303_test.png");
	
	TCanvas *c25 = new TCanvas();
        mominex306->Draw();
        c25->SaveAs("images/mominex306_test.png");
	TCanvas *c26 = new TCanvas();
        mominey306->Draw();
        c26->SaveAs("images/mominey306_test.png");
	TCanvas *c27 = new TCanvas();
        mominez306->Draw();
        c27->SaveAs("images/mominez306_test.png");
	TCanvas *c28 = new TCanvas();
        toteine306->Draw();
        c28->SaveAs("images/toteine306_test.png");
